...
<body id="page-top">
    ...
    <h1 class="h3 mb-2 text-gray-800">Edit Data Abjad</h1>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Data Abjad</h6>
        </div>
        <div class="card-body">
            <form action="/alphabet/update/{{ $abjadCards->id }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                <div class="col-md-6">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        @if ($abjadCards->image_url)
                            <input type="hidden" name="old_foto" value="{{ $abjadCards->image_url }}">
