...
<body id="page-top">
    ...
    <h1 class="h3 mb-2 text-gray-800">Edit Data Kata Sederhana</h1>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Data Sederhana</h6>
        </div>
        <div class="card-body">
            <form action="/word/update/{{ $wordCards->id }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="word" class="form-label">Kata Sederhana</label>
                        <input type="text" class="form-control" id="word" name="word" value="{{ $wordCards->word }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="description_video" name="description_video" value="{{ $wordCards->description_video }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        @if ($wordCards->image_url)
                            <input type="hidden" name="old_foto" value="{{ $wordCards->image_url }}">
                            <img src="{{ asset('storage/' . $wordCards->image_url) }}" alt="Current Foto" style="max-width: 200px; margin-top: 5px;">
                        @endif
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Deskripsi</label>
                        <input type="text" class="form-control" id="description" name="description" value="{{ $wordCards->description}}">
                    </div>
                </div>
