        ...
        <div class="w-2/5 p-8 md:mt-56">
            ...
            <form action="/register" method="POST">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="username" class="peer-focus:font-medium absolute text-lg text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:text-blue-600">Nama</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
